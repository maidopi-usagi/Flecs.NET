// /_/src/Flecs.NET/Generated/Ecs/FetchPointers/T14.g.cs
...
public static unsafe partial class Ecs
{
    ...
    {
        ptrs[0] = ecs_ensure_id(world, e, Type<T0>.Id(world), Type<T0>.Size); ptrs[1] = ecs_ensure_id(world, e, Type<T1>.Id(world), Type<T1>.Size); ptrs[2] = ecs_ensure_id(world, e, Type<T2>.Id(world), Type<T2>.Size); ptrs[3] = ecs_ensure_id(world, e, Type<T3>.Id(world), Type<T3>.Size); ptrs[4] = ecs_ensure_id(world, e, Type<T4>.Id(world), Type<T4>.Size); ptrs[5] = ecs_ensure_id(world, e, Type<T5>.Id(world), Type<T5>.Size); ptrs[6] = ecs_ensure_id(world, e, Type<T6>.Id(world), Type<T6>.Size); ptrs[7] = ecs_ensure_id(world, e, Type<T7>.Id(world), Type<T7>.Size); ptrs[8] = ecs_ensure_id(world, e, Type<T8>.Id(world), Type<T8>.Size); ptrs[9] = ecs_ensure_id(world, e, Type<T9>.Id(world), Type<T9>.Size); ptrs[10] = ecs_ensure_id(world, e, Type<T10>.Id(world), Type<T10>.Size); ptrs[11] = ecs_ensure_id(world, e, Type<T11>.Id(world), Type<T11>.Size); ptrs[12] = ecs_ensure_id(world, e, Type<T12>.Id(world), Type<T12>.Size); ptrs[13] = ecs_ensure_id(world, e, Type<T13>.Id(world), Type<T13>.Size);
        return true;
    }
